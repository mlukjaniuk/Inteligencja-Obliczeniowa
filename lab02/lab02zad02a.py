...
#niech algorytm działa dopóki fitness najlepszego osobnika nie będzie równy 1600
while ga_instance.best_solution()[1] <= 1600:
    ga_instance.run()
    print("Best solution : ", ga_instance.best_solution()[0])
    print("Best solution fitness : ", ga_instance.best_solution()[1])
